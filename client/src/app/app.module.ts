...
import { SubblogSideBarComponent } from './shared/subblog-side-bar/subblog-side-bar.component';
...
@NgModule({
  declarations: [
    ...
    PostTileComponent,
    SideBarComponent,
    SubblogSideBarComponent,
    VoteButtonComponent,
    CreateSubblogComponent,
    CreatePostComponent,
    ListSubblogsComponent,
    ViewPostComponent,
